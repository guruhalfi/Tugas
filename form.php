<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      $TTL = $_POST['TTL'];
      //query SQL
      $query = "INSERT INTO mhs (nrp, nama, jenis_kelamin, alamat, TTL) VALUES('$nrp','$nama','$jenis_kelamin','$alamat','$TTL')"; 
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <form action="form.php" method="POST">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label>Lahir</label>
              <input type="text" class="form-control" placeholder="yyyymmdd" name="TTL" required="required">
            </div>
