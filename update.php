<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      $TTL = $_POST['TTL'];
      //query SQL
      $sql = "UPDATE mhs SET nama='$nama', jenis_kelamin='$jenis_kelamin', alamat='$alamat', TTL='$TTL' WHERE nrp='$nrp'";
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <form action="update.php" method="POST">
            ...
            <div class="form-group">
              <label>Lahir</label>
              <input type="text" class="form-control" placeholder="yyyymmdd" name="TTL" value="<?php echo $data['TTL'];  ?>" required="required">
            </div>
            <?php endwhile; ?>
